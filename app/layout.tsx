      ...
      <body>
        <nav className="flex items-center justify-between p-6 max-w-7xl mx-auto">
          ...
          <div className="space-x-4 flex">
            ...
            <a href="/styles" className="hover:text-blue-600">Styles</a>
        ...
        <footer className="bg-gray-50 border-t py-12 mt-20">
          <div className="max-w-7xl mx-auto px-6 grid grid-cols-2 md:grid-cols-4 gap-8">
            <div>
              ...
              <p className="text-sm text-gray-500">AI Outfit Generator & Virtual Try-On</p>
            </div>
            <div>
          ...
          <div className="max-w-7xl mx-auto px-6 mt-12 text-center text-sm text-gray-400">
